$(function () {
    ...
    /*Add new category*/
    var newCatA = $("a#newcata"); /*Add libk class*/
    var newCatTextInput = $("#newcatname"); /*class text input*/
    var ajaxText = $("span.ajax-text"); /*class img loader*/
    var table = $("table#pages tbody"); /*class table of input*/

    /* function of Enter click */
